...
export const AddItemComponent = ({titlePage , tabelName , to }) => {
...
title:"Add this item in Menu",
ok:"Ok",
cancel:"Cancel",
icon:"info"

  })
if(!Alert_massege) return;
    // send data to subpase
   ...
   // تحديث القيمة في الـ Context
if (data && data.length > 0) {
  setGetData((prev) => [...prev, ...data]); // data عبارة عن Array
}
  ...
  return (
    <div className=" w-full ">
      <div className=" item_menu w-5xl mx-auto xl:w-4xl lg:w-2xl md:w-xl sm:w-lg  flex flex-col gap-4">
        <h1 className="text-3xl font-bold ml-10">{titlePage}</h1>
      ...
      <label htmlFor="discount">Discount </label>
          ...
          {item.discount <= 0 && error == true && (
            <span className="text-red-500 text-sm">item Discount is Requerd</span>
          )}
          <div className="my-4">
